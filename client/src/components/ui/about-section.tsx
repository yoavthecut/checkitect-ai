  ...
  const teamFeatures = [
    {
      ...
      title: "Expert Team",
      subtitle: "PhDs in Urban Planning and AI Engineering"
    },
    {
      id: "team-recognition",
      icon: (
      ...
      subtitle: "Winner of Smart City Innovation Award 2024"
    },
    {
      id: "team-partners",
      icon: (
      ...
      subtitle: "Working with 50+ municipalities nationwide"
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-muted-foreground mb-6" data-testid="about-intro">
              Founded by urban planning and AI experts, Checkitect AI bridges the gap between traditional compliance processes and modern technology solutions.
            </p>
            <p className="text-muted-foreground mb-8" data-testid="about-description">
              Our team combines decades of experience in architecture, urban planning, and artificial intelligence to create solutions that truly understand the complexities of building compliance and municipal regulations.
            </p>
              ...
              {teamFeatures.map((feature) => (
                <div key={feature.id} className="flex items-center" data-testid={feature.id}>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm" data-testid={`${feature.id}-subtitle`}>
                      {feature.subtitle}
                    </p>
                  </div>
                </div>
