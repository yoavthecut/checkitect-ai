    ...
    <footer className="bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-4" data-testid="footer-product-title">Product</h4>
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-4" data-testid="footer-company-title">Company</h4>
            <ul className="space-y-2">
              {footerSections.company.map((link) => (
                <li key={link.name}>
                  <button
                    onClick={() => scrollToSection(link.href)}
                    className="text-muted-foreground hover:text-foreground transition-colors text-left"
                    data-testid={`footer-company-${link.name.toLowerCase().replace(' ', '-')}`}
                  >
                    {link.name}
                  </button>
                </li>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm" data-testid="footer-copyright">
            © 2024 Checkitect AI. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 sm:mt-0">
            <button className="text-muted-foreground hover:text-foreground text-sm transition-colors" data-testid="footer-privacy">
              Privacy Policy
            </button>
            <button className="text-muted-foreground hover:text-foreground text-sm transition-colors" data-testid="footer-terms">
              Terms of Service
            </button>
          </div>
        </div>
